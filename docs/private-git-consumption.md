...
Utiliser un **tag de release** (ex. `v0.14.0`) comme `ref`, jamais `main` (stabilité
...
dependencies:
  zcrud_flashcard:
    git: { url: git@github.com:zakarius-dev/zcrud.git, ref: v0.14.0, path: packages/zcrud_flashcard }
...
dependency_overrides:
  zcrud_core:
    git: { url: git@github.com:zakarius-dev/zcrud.git, ref: v0.14.0, path: packages/zcrud_core }
  zcrud_annotations:
    git: { url: git@github.com:zakarius-dev/zcrud.git, ref: v0.14.0, path: packages/zcrud_annotations }
  zcrud_study_kernel:
    git: { url: git@github.com:zakarius-dev/zcrud.git, ref: v0.14.0, path: packages/zcrud_study_kernel }
  zcrud_markdown:
    git: { url: git@github.com:zakarius-dev/zcrud.git, ref: v0.14.0, path: packages/zcrud_markdown }
  zcrud_export:
...
dependency_overrides:
  ...
  zcrud_chat_firestore:
    git: { url: git@github.com:zakarius-dev/zcrud.git, ref: v0.18.0, path: packages/zcrud_chat_firestore }
  zcrud_chat_material:
