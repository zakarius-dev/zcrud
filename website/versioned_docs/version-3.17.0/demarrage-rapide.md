...
- [L'écran CRUD assemblé](paquets/zcrud_screen.md) — `ZCrudScreen` recoud pour vous le
  cycle complet (recherche, création, édition, sauvegarde, corbeille, fiche de détail)
  autour du formulaire et de la liste montés ci-dessus, à partir d'une déclaration ; la
  [recette du cookbook](guides/cookbook.md#ecran-crud-assemble) en donne la forme
  minimale.
