...
Toutes les modifications notables de `zcrud_exam` sont documentées dans ce
...
- `README.md` du paquet (gabarit de la charte documentaire) : aperçu,
  ...
  et invariants.
- Fiche `docs/site/paquets/zcrud_exam.md` (rôle, quand l'utiliser, types
  clés).
...
Historique antérieur : voir `git log` sur `packages/zcrud_exam/`.
