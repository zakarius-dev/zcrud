// Squelette PARTAGÉ des gardes qui LISENT LES SOURCES de `zcrud_exam`.
//
// 🔴 P0D3 (chantier dartdoc) : `no_datetime_now_test.dart` dépouillait déjà
// les commentaires, mais avec un dé-commentateur REGEX « bloc PUIS ligne »
...
// (`@TestOn('vm')` déjà porté par `no_datetime_now_test.dart` — `zcrud_exam`
// est pur-Dart et rejoué sous `gate:web`, d'où le tag explicite). Ce fichier
// n'est pas un `*_test.dart` lui-même.
library;
