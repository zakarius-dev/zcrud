/// Service de **partage / impression** de bytes PDF. Arête `printing`
/// **confinée** (avec `z_pdf_preview.dart`).
///
/// La destination des bytes (le PDF déjà produit par
/// `ZFlashcardPdfTemplate`, PUR) est une opération de PLATEFORME : elle vit
/// dans ce satellite, jamais dans `zcrud_export`.
///
...
/// Gardé par un test de confinement dédié.
library;
