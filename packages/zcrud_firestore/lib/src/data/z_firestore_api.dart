...
/// AD-1 effectivement utilisées (acyclicité tangible, pas d'import mort).
abstract final class ZFirestoreApi {
  const ZFirestoreApi._();

  /// Version de l'API publique au stade squelette.
  static const String version = '0.0.1';

  /// Rattache l'arête AD-1 `zcrud_firestore -> zcrud_core`.
