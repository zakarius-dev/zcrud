...
/// App-bar **recherchable** déclarative et thémable.
///
...
class ZSearchableAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Typographie du TITRE — priorité **paramètre > jeton
  ...
  ///
  /// Sans effet en **mode recherche**: le titre cède alors la place au champ
  ...
  ///
  /// **Le facteur d'échelle de texte sature.** `AppBar` borne le
  ...
  /// Sous-titre optionnel rendu **sous le titre**. `null` (défaut)
  ...
  /// Configuration de recherche (nulle ⇒ pas de loupe, pas de champ).
...
class ZSearchableAppBarState extends State<ZSearchableAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    // texte via son controller (invariant AD-2).
