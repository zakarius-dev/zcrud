/// Sévérité d'un toast, modélisée par un **enum**.
///
/// `ZToastSeverity` remplace les méthodes ad hoc `showErrorToast` /
/// `showSuccessToast` / `showInfoToast` et tout `bool isError` / `String`
/// de type libre : les variantes de notification sont les **valeurs d'un
/// enum nommé**, jamais un flag binaire opaque. Le widget de présentation
/// ([ZScaffoldMessengerToaster]) **dérive** la couleur du toast du
