// E2-9 AC8 : garde d'ISOLEMENT D'IDIOME — aucun idiome GetX/get_it/Riverpod dans
// `zcrud_provider/lib`. `provider` est le seul manager autorisé ici.
import 'dart:io';

import 'package:flutter_test/flutter_test.dart';

Directory _libDir() {
  for (final base in <String>['', 'packages/zcrud_provider/']) {
...
void main() {
  ...
  test('zcrud_provider/lib ne contient aucun idiome GetX/get_it/Riverpod (AC8)',
      () {
    ...
    expect(offenders, isEmpty,
        reason: 'Idiomes d\'un autre manager dans zcrud_provider:\n'
            '${offenders.join('\n')}');
  });
}
