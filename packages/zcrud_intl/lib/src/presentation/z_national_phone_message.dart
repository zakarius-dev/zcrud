...
/// **l10n** résolu (invariants AD-1, AD-13).
///
/// Le discriminant d'erreur du domaine ([ZNationalPhoneError]) est
/// **neutre** (sans message, invariant AD-1). La traduction vit ici, dans
/// la couche présentation, via `label(context, key, fallback:)` de
/// `zcrud_core` — repli **français**, surchargeable via
/// `ZcrudScope(labels:)` (**aucune** table ajoutée au cœur).
///
/// Le message renvoyé est destiné à `InputDecoration.errorText` : il est
/// **annoncé par le lecteur d'écran** via la sémantique native du
/// `TextField` (invariant AD-13).
library;
