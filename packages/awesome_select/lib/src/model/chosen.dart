...
/// Chosen data class
// fp-4-1 compat Dart 3 : une classe utilisée en `with` (S2ChosenNotifier) doit
// être `mixin`/`mixin class`. `abstract mixin class` préserve `extends`
// (S2SingleChosen/S2MultiChosen) ET `with` (S2ChosenNotifier).
