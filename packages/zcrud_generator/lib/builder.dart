/// Fabrique de `Builder` `build_runner` de `zcrud_generator` (invariant AD-3).
///
...
/// (en-tête `// GENERATED CODE - DO NOT MODIFY BY HAND`, `.g.dart` régénéré).
/// La toolchain codegen (`build`/`source_gen`/`analyzer`) reste confinée à ce
/// package (`dev_dependency` — invariant AD-1) : elle ne fuit jamais chez les
/// consommateurs.
library;
