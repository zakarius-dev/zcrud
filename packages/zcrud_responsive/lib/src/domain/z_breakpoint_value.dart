/// Valeur générique **dépendante du breakpoint fin** — primitive de
...
///
/// **Réutilisation du cœur**: l'axe de paliers est
...
/// redéclarés.
///
/// **Découplage 5 ↔ 3 paliers**: cette échelle **fine à 5 paliers** est
...
class ZBreakpointValue<T> {
  ...
  /// retombent sur `xs` via le cœur (défaut sûr, invariant AD-10).
