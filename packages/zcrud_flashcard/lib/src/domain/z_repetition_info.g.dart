...
/// Clés que `ZRepetitionInfo.toMap()` PEUT produire — surensemble
...
void registerZRepetitionInfo(ZcrudRegistry registry) {
  ...
  _$zRequireExtraPreserved<ZRepetitionInfo>(
    'ZRepetitionInfo',
    ZRepetitionInfo.fromMap,
    (value) => value.toMap(),
    (value) => value.extra,
  );
...
const Set<String> $ZRepetitionInfoTimestampFields = <String>{};
