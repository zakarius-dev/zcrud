...
enum ZScreenMode {
  ...
  /// **Fiche de détail** : la liste ne crée rien et n'a pas de corbeille, mais
  /// chaque ligne s'ouvre en **consultation du formulaire entier** — tous ses
  /// champs, rendus en lecture seule, et non les seules colonnes affichées.
  ///
  /// Le retour vers l'édition reste offert : l'action « modifier » est rendue
  /// **si et seulement si** l'ACL autorise `ZCrudAction.update`.
  details,
