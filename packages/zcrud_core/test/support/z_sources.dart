// Primitives PARTAGÉES des gardes qui LISENT LES SOURCES de `zcrud_core`.
//
...
/// Racine du package `zcrud_core`, que le test tourne depuis
/// `packages/zcrud_core` (`flutter test`, convention `melos exec`) ou depuis la
/// racine du dépôt (CI).
Directory packageRoot() {
  for (final String p in <String>['.', 'packages/zcrud_core']) {
  ...
  fail('racine de zcrud_core introuvable depuis ${Directory.current.path}');
}
