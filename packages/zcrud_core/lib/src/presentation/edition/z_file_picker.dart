/// `ZFilePicker` — **seam d'acquisition de fichier** injecté.
///
...
/// dans l'app/le binding, **jamais** dans `zcrud_core` (invariant AD-1 : cœur
...
/// avec métadonnées + `localPath` — **jamais des octets** (invariant AD-2 : la
/// tranche reste légère ; le transport binaire est la responsabilité de
/// l'impl picker/storage). En test, un **fake** renvoie un [AppFile] déterministe.
library;
...
/// singleton statique — invariant AD-6).
