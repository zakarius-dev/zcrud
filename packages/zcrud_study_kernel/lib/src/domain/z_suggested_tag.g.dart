...
ZSuggestedTag _$ZSuggestedTagFromMap(Map<String, dynamic> map) => ZSuggestedTag(
  title: map['title'] is String ? map['title'] as String : '',
  colorKey: map['color_key'] is String ? map['color_key'] as String : '',
);

extension ZSuggestedTagZcrud on ZSuggestedTag {
...
/// Clés que `ZSuggestedTag.toMap()` PEUT produire — surensemble
...
void registerZSuggestedTag(ZcrudRegistry registry) =>
    registry.register<ZSuggestedTag>(
      'suggested_tag',
      fromMap: ZSuggestedTag.fromMap,
      toMap: (value) => value.toMap(),
      fieldSpecs: $ZSuggestedTagFieldSpecs,
    );
...
const Set<String> $ZSuggestedTagTimestampFields = <String>{};
