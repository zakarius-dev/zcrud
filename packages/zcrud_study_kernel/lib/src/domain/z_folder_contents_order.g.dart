...
part of 'z_folder_contents_order.dart';
...
ZFolderContentsOrder _$ZFolderContentsOrderFromMap(Map<String, dynamic> map) =>
    ZFolderContentsOrder(
      folderId: map['folder_id'] is String ? map['folder_id'] as String : '',
    );

extension ZFolderContentsOrderZcrud on ZFolderContentsOrder {
...
/// Clés que `ZFolderContentsOrder.toMap()` PEUT produire — surensemble
...
void registerZFolderContentsOrder(ZcrudRegistry registry) {
  ...
  _$zRequireExtraPreserved<ZFolderContentsOrder>(
    'ZFolderContentsOrder',
    ZFolderContentsOrder.fromMap,
    (value) => value.toMap(),
    (value) => value.extra,
  );
  registry.register<ZFolderContentsOrder>(
...
const Set<String> $ZFolderContentsOrderTimestampFields = <String>{};
