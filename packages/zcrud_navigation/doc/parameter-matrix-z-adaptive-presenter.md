...
<!-- Source : packages/zcrud_navigation/test/support/z_presenter_parameter_matrix.dart -->
<!-- Garde de synchronisation : packages/zcrud_navigation/test/z_presenter_parameter_matrix_test.dart -->

# Matrice paramètre × mode — `ZAdaptivePresenter`
...
Ce document couvre **`ZAdaptivePresenter`** (`packages/zcrud_navigation/lib/src/presentation/z_adaptive_presenter.dart`), et lui seul. L'autre implémentation du port livrée par le dépôt a sa propre matrice, mesurée par sa propre garde :
